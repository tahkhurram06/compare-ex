      ...
      <div className="compare-tray-inner">
        <div className="compare-tray-thumbs">
            ...
            return (
              <div className="compare-tray-item" key={phone.id}>
                <div
                  ...
                  style={thumbImage ? { backgroundImage: `url(${getPhoneImage(thumbImage)})` } : undefined}
                  title={phone.name}
                />
                <button
                  type="button"
          ...
          {Array.from({ length: emptySlots }).map((_, i) => (
            <div className="compare-tray-slot" key={`empty-${i}`} aria-hidden="true" />
          ))}
        </div>

        <span className="compare-tray-count">{phones.length} of {MAX_COMPARE} selected</span>
        ...
        <button
          ...
          title={phones.length < 2 ? 'Add at least 2 phones to compare' : undefined}
        >
